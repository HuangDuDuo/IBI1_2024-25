...
In_1990=dalys_data.loc[Year_1990,"DALYs"]
print ("DALYs of all countries in 1990:\n",In_1990)
...
#Additional question: boxplot of 1990
plt.boxplot(dalys_data.loc[Year_1990,'DALYs'])
